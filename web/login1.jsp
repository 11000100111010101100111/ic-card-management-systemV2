...
<%--        <span style="width: 100%;height: 100%">1</span>--%>
        <div alt="" style="background-image: url('${pageContext.request.contextPath}/theame/img/logo.png');width: 90px;height: 40px;margin-top: 20px;margin-left: 20px;"></div>
    </div>
                ...
                <div class="from">
                    <div class="input">
                        <div class="inline-ele notfocus">
                            ...
                            --><input type="text" class="inline-block-ele" id="uid" placeholder="请输入账号" autocomplete="off">
                        </div>
                    ...
                    <div class="input">
                        <div class="inline-ele notfocus">
                            ...
                            --><input type="password" class="inline-block-ele" id="upwd" placeholder="请输入密码" autocomplete="off">
                        </div>
                    ...
                    <div class="input" style="">
                        ...
                        <div class="inline-ele notfocus" style="width: 52%;height: 31px;display: inline-block;">
                            ...
                            --><input type="text" style="height:100%;width:75%;font-size: 11px;" class="inline-block-ele" id="ucode" placeholder="请输入验证码" autocomplete="off">
                        </div>
...
<script href="${pageContext.request.contextPath}/theame/js/jquery-1.8.3.js"></script>
<%--login--%>
...
<script>
    ...
    var yPositions = Array(100).join(0).split('');
