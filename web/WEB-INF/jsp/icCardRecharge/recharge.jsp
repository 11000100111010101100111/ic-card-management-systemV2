...
<head>
    ...
    <style>
        ...
        .recharge-content .recharge-top .card-balance-panel .balance-box .font-box ul li:last-child{
            padding: 3px 5px;
