...
<%--      transform: translate(-50%, -50%);--%>
<%--      border-radius: 50%;--%>
<%--    &lt;%&ndash;background: url("${pageContext.request.contextPath}/theame/img/gril.JPG") no-repeat;&ndash;%&gt;--%>
<%--    &lt;%&ndash;background-position: center;&ndash;%&gt;--%>
<%--    &lt;%&ndash;background-size: 100% 100%;&ndash;%&gt;--%>
...
<body>
<jsp:forward page="go/home"></jsp:forward>
<%--<%  response.sendRedirect("");  %>--%>
<%--<%  pageContext.forward("/go/login");   %>--%>
<%--&lt;%&ndash;<div class="msg-show">&ndash;%&gt;--%>
...
<%--    &lt;%&ndash;        <span style="width: 100%;height: 100%">1</span>&ndash;%&gt;--%>
...
<%--            </div>--%>
<%--&lt;%&ndash;            <label class="lab-id inline-ele" >error:12323!</label>&ndash;%&gt;--%>
<%--          </div>--%>
<%--          <div class="input">--%>
<%--            <div class="inline-ele notfocus">--%>
...
<%--            </div>--%>
<%--&lt;%&ndash;            <label class="lab-pwd inline-ele" >error:12323!</label>&ndash;%&gt;--%>
<%--          </div>--%>
...
<%--              </canvas>--%>
<%--            </div>--%>
<%--&lt;%&ndash;            <label class="lab-code inline-ele" >error:12323!</label>&ndash;%&gt;--%>
...
<%--    &lt;%&ndash;        <div class="left-panel"><span style="width: 100%;height: 100%">2-1</span></div>&ndash;%&gt;--%>
<%--    &lt;%&ndash;        <div class="right-panel"><span style="width: 100%;height: 100%">2-2</span></div>&ndash;%&gt;--%>
<%--  </div >--%>
<%--  <div id="container">--%>
...
<%--  </div>--%>
<%--</div>--%>
<%--&lt;%&ndash;<script href="${pageContext.request.contextPath}/theame/js/jquery-3.6.0.js"></script>&ndash;%&gt;--%>
